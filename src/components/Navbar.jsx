    ...
    <div>
      <nav className="pt-2.5">
        <ul className="flex justify-between items-center">
          <li className="flex flex-col gap-5 pr-5">
            <div className="flex gap-5">
              ...
              <input
                className="bg-gray-100 rounded-3xl w-[30vw] "
                type="text"
                placeholder="جستوجو"
              />
            </div>
            <div>
              <li className="flex justify-between text-gray-400 w-[59vw]">
                <a className="hover:border-b-2 hover:border-red-500 h-10 transition-all duration-100 rounded-[3px] ">دسته‌بندی کالاها</a>
                <a className="hover:border-b-2 hover:border-red-500 h-10 transition-all duration-100 rounded-[3px] " href="https://www.digikala.com/incredible-offers/">
                  شگفت‌انگیزها
                </a>
                <a className="hover:border-b-2 hover:border-red-500 h-10 transition-all duration-100 rounded-[3px] " href="https://www.digikala.com/fresh/?utm_source=digikala-web&utm_medium=home-category">
                  سوپرمارکت
                </a>
                <a className="hover:border-b-2 hover:border-red-500 h-10 transition-all duration-100 rounded-[3px] " href="https://www.digikala.com/wealth/my-assets/?utm_source=dk&utm_medium=undersearchbutton&utm_campaign=fixbutton">
                  طلا و نقره دیجیتال
                </a>
                <a className="hover:border-b-2 hover:border-red-500 h-10 transition-all duration-100 rounded-[3px] " href="https://www.digikala.com/best-selling/">
                  پرفروش‌ ترین‌ها
                </a>
                <a className="hover:border-b-2 hover:border-red-500 h-10 transition-all duration-100 rounded-[3px] " href="https://www.digikala.com/best-selling/">دیجی استایل</a>
                <a className="hover:border-b-2 hover:border-red-500 h-10 transition-all duration-100 rounded-[3px] " href="https://www.digikala.com/landings/seller-introduction/">
                  در دیجی‌کالا بفروشید!
                </a>
              </li>
            </div>
          </li>
          <li className="pl-5 text-6xl flex items-center">
            <Link
              to="/profile"
              className="flex w-20 h-20 rounded-2xl justify-center items-center transition-all hover:bg-red-300"
            >
              P
            </Link>
          </li>
