...
function Activity() {
  return (
    <div className="flex flex-col rounded-[10px] w-[60vw] h-[40vh] border-2 border-gray-200">
      <div className="flex justify-between px-5 pt-8">
        <p className="font-bold">سفارش‌های من</p>
        <p className="font-bold text-sky-500">مشاهده همه</p>
      </div>
      <br />
      <div className="flex justify-between px-5 pt-8">
            ...
            <g filter="url(#filter0_d)">
              <g clip-path="url(#clip0)">
                ...
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M41.6 35.2H45.8666L43.7333 45.8667H39.4666L41.6 35.2Z"
                  fill="#2BD1FF"
                  fill-opacity="0.541275"
                />
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M33.0666 35.2H37.3333L35.2 45.8667H30.9333L33.0666 35.2Z"
                  fill="#2BD1FF"
                  fill-opacity="0.541275"
                />
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M50.1333 35.2H54.4L52.2666 45.8667H48L50.1333 35.2Z"
                  fill="#2BD1FF"
                  fill-opacity="0.541275"
                />
              </g>
          ...
          >
            ...
            <g filter="url(#filter0_i)">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M21.3333 37.12L24.9173 33.7067L29.3973 37.9733L40.1493 27.7333L43.7333 31.1467L29.3973 44.8L21.3333 37.12Z"
            ...
            <defs>
              ...
              >
                ...
                <feColorMatrix
                  type="matrix"
                  values="0 0 0 0 0.0493759 0 0 0 0 0.339079 0 0 0 0 0.0644254 0 0 0 0.4 0"
                />
                <feBlend
                  mode="normal"
                  in2="shape"
        ...
        <div className="font-bold flex gap-3 items-center">
          ...
          >
            ...
            />
            <path
              d="M10.6667 17.9333C10.6667 16.2765 12.0098 14.9333 13.6667 14.9333H50.3333C51.9902 14.9333 53.3333 16.2765 53.3333 17.9333V53.6667C53.3333 56.4281 51.0947 58.6667 48.3333 58.6667H15.6667C12.9052 58.6667 10.6667 56.4281 10.6667 53.6667V17.9333Z"
              fill="url(#paint1_linear)"
            />
            <g filter="url(#filter0_i)">
              <path
                d="M26.6667 25.6L20.2667 32L26.6667 38.4H33.0667L28.8 34.1333H36.2667L36.4796 34.1386C38.7371 34.2495 40.5333 36.115 40.5333 38.4C40.5333 40.7564 38.6231 42.6667 36.2667 42.6667H22.4V46.9333H36.2667L36.5325 46.9293C41.1223 46.7889 44.8 43.0239 44.8 38.4C44.8 33.6872 40.9795 29.8667 36.2667 29.8667H28.8L33.0667 25.6H26.6667Z"
                fill="#D09A2D"
              />
            </g>
            <defs>
              ...
              >
                ...
                <feColorMatrix
                  type="matrix"
                  values="0 0 0 0 0.6875 0 0 0 0 0.480719 0 0 0 0 0.0633265 0 0 0 1 0"
                />
                <feBlend
                  mode="normal"
                  in2="shape"
